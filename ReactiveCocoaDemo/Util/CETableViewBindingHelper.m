...
- (instancetype) initWithTableView:(UITableView *)tableView
                      sourceSignal:(RACSignal *)source
                  selectionCommand:(RACCommand *)selection
                 templateCellClass:(UITableViewCell *)templateCellClass {
    if (self = [super init]) {
        _tableView = tableView;
        _data = [NSArray array];
        _selection = selection;
        ...
        // create an instance of the template cell and register with the table view
        _templateCell = [[UITableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:_templateCell.reuseIdentifier];
    
//        [_tableView registerClass:[UITableViewCell class] forCellReuseIdentifier:_templateCell.reuseIdentifier];
...
+ (instancetype) bindingHelperForTableView:(UITableView *)tableView
                              sourceSignal:(RACSignal *)source
                          selectionCommand:(RACCommand *)selection
                         templateCellClass:(UITableViewCell *)templateCell {
    return [[CETableViewBindingHelper alloc] initWithTableView:tableView
                                                  sourceSignal:source
                                              selectionCommand:selection
                                                  templateCellClass:templateCell];
...
//    if (cell == nil) {
//       UITableViewCell *cell = [[UITableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:_templateCell.reuseIdentifier];
//        return  cell;
//    }
//    
